...
> **💡 Note**: The Jetpack Compose team announced the official `compose-runtime-annotation` library. For more information, read [Mark your models as stable with the Compose runtime annotation library](https://www.revenuecat.com/blog/engineering/compose-runtime-annotation/).
